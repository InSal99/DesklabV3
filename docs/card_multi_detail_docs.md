...
| ------------------- |---------------------------------------------------------------------------------------------------------------------------------------------------|
| Full Featured (Icon) | ![Icon + Title + Info1 + Info2 + Right Arrow](https://res.cloudinary.com/dacnnk5j4/image/upload/v1759227886/cmdc_full_featured_icon_m7uuar.gif)   |
| Single Info (Icon) | ![Icon + Title + Info1 + Right Arrow](https://res.cloudinary.com/dacnnk5j4/image/upload/v1759227886/cmdc_single_info_icon_mqvb9c.gif)             |
| Full Featured (Image) | ![Image + Title + Info1 + Info2 + Right Arrow](https://res.cloudinary.com/dacnnk5j4/image/upload/v1759227885/cmdc_full_featured_image_zngf7t.gif) |
| Non-Clickable (Image) | ![Image + Title + Info1 + Info2](https://res.cloudinary.com/dacnnk5j4/image/upload/v1759227884/cmdc_non_clickable_image_icn2ej.png)               |
| Minimal | ![Title + Info1 + Info2](https://res.cloudinary.com/dacnnk5j4/image/upload/v1759227884/cmdc_minimal_ha1zej.png)                                                                                                                        |
