...
class Chip @JvmOverloads constructor(
    ...
    private fun setupIconClickListener() {
        binding.ivChip.setOnClickListener {
            handleIconClick()
        }
    ...
    private fun resolveAttrColor(@AttrRes attrRes: Int): Int {
        ...
        return if (context.theme.resolveAttribute(attrRes, typedValue, true)) {
            ...
            0 // Return transparent if attribute not found
        }
    }
        ...
        when (pressState) {
            PressState.REST -> {
                val elevatedModifierDrawable = GradientDrawable().apply {
                    ...
                    setColor(resolveAttrColor(R.attr.colorBackgroundModifierCardElevated))
                }
            ...
            PressState.ON_PRESS -> {
                val overlayDrawable = GradientDrawable().apply {
                    cornerRadius = 999.dpToPx.toFloat()
                    setColor(resolveAttrColor(R.attr.colorBackgroundModifierOnPress))
                }
