...
class ChipTeamReportAdapter(
    private var chipTexts: Array<String> = arrayOf("Mingguan", "Bulanan"),
    private var selectedPosition: Int = 0,
    private val onChipClick: (position: Int, chipText: String) -> Unit
) : RecyclerView.Adapter<ChipTeamReportAdapter.ChipViewHolder>() {
    ...
    private fun getChipBackgroundColor(chipText: String, context: android.content.Context): Int {
        return when (chipText) {
            ...
            "Bulanan" -> resolveColorAttribute(R.attr.colorBackgroundPrimaryInverse, context)
