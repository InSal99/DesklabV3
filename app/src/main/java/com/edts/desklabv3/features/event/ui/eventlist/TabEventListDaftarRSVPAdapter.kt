...
class TabEventListDaftarRSVPAdapter(
    private var tabTexts: Array<String> = arrayOf("Daftar Event", "Event Saya", "Undangan"),
    private var selectedPosition: Int = 0,
    private val onTabClick: (position: Int, tabText: String) -> Unit
) : RecyclerView.Adapter<TabEventListDaftarRSVPAdapter.TabViewHolder>() {
